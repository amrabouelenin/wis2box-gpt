...
La API de wis2box proporciona acceso de descubrimiento y consulta de manera legible por máquina a los datos que han sido ingestados en wis2box. La API se basa en el estándar OGC API - Features y está implementada usando [pygeoapi](https://pygeoapi.io).
