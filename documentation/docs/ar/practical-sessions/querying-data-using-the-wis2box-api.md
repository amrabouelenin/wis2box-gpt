...
??? success "انقر لكشف الإجابة"
    يجب أن يتم عرض 4 مجموعات، بما في ذلك "المحطات"، "بيانات الاكتشاف الوصفية"، و"إشعارات البيانات"
...
!!! note
    المثال أعلاه مبني على بيانات اختبار مالاوي. جرب الاختبار ضد المحطات التي قمت بإدخالها كجزء من التمارين السابقة.

## فحص الملاحظات

!!! note
    المثال أعلاه مبني على بيانات اختبار مالاوي. جرب الاختبار ضد الملاحظات التي قمت بإدخالها كجزء من التمارين.
...
??? success "انقر لكشف الإجابة"
    باستخدام معرف الخاصية من طلب واجهة ضد الملاحظات، استعلم عن الواجهة لـ `http://<your-host>/oapi/collections/{collectionId}/items/{featureId}`، حيث `{collectionId}` هو اسم مجموعة الملاحظات الخاصة بك و`{itemId}` هو معرف الملاحظة المفردة ذات الاهتمام.
