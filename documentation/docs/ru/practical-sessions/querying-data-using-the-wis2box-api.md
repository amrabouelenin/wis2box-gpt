...
На этой практической сессии вы научитесь использовать API данных для просмотра и запроса данных, загруженных в wis2box.
...
!!! question
    Сколько станций возвращается? Сравните это число со списком станций по адресу `http://<your-host>/wis2box-webapp/station`
...
??? success "Нажмите, чтобы увидеть ответ"
    Кликнув по ссылке 'JSON' в верхнем правом углу страницы или добавив `f=json` к запросу API в веб-браузере.
