...
Clicca sul pulsante 'ADVANCED', rimuovi gli argomenti preconfigurati e aggiungi i seguenti argomenti a cui iscriverti:
...
Usa MQTT per esplorare la struttura degli argomenti sotto gli argomenti `origin`.
